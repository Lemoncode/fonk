import { DeepKey } from '@lemoncode/fonk';

export const setValues = <Model extends Record<string, any>>(values: Model) => {
...
export const setErrors = <Model>(errors: Record<DeepKey<Model>, string>) => {
